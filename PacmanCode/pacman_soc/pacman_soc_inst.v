	pacman_soc u0 (
		...
		.rnd_dir1_export        (<connected-to-rnd_dir1_export>),        //        rnd_dir1.export
		.rnd_percent_export     (<connected-to-rnd_percent_export>),     //     rnd_percent.export
		.rnd_dir2_export        (<connected-to-rnd_dir2_export>),        //        rnd_dir2.export
		.rnd_dir3_export        (<connected-to-rnd_dir3_export>)         //        rnd_dir3.export
	);
