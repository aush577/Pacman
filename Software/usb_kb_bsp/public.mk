...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../pacman_soc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is pacman_soc
SOPC_NAME := pacman_soc
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1556775246
SOPC_SYSID_FLAG += --timestamp=1556775246
ELF_PATCH_FLAG  += --timestamp 1556775246
